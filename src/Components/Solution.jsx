       ...
       <h1 className='text-green-600 font-bold text-5xl ms-[8rem] mt-2 ' >Solution</h1>
         ...
         <div className='card bg-green-500 w-[14.5rem] h-[19rem] flex align-middle justify-center pt-2 flex-col'>
          <img src={images2} className='h-[10rem] w-[10rem] ms-[2.2rem] my-3'/>
            <h1 className='text-center text-white text-2xl font-bold'>Automated <br/>agricolture</h1>
         </div>
         <div className='card bg-green-600 w-[14.5rem] h-[19rem] flex align-middle justify-center pt-2 flex-col'>
          <img src={images3} className='h-[10rem] w-[10rem] ms-[2.2rem] my-3'/>
            <h1 className='text-center text-white text-2xl font-bold'>Depuration <br/>rain water</h1>
         </div>
         <div className='card bg-green-500 w-[14.5rem] h-[19rem] flex align-middle justify-center pt-2 flex-col'>
          <img src={images4} className='h-[10rem] w-[10rem] ms-[2.2rem] my-3'/>
            <h1 className='text-center text-white text-2xl font-bold'>Mosquito <br/>Prevention</h1>
         </div>
      {/* Cards Row 2 */}
         </div>
         {/* Discovery's Images */}
         ...
         <div className='card bg-green-500 w-[14.5rem] h-[19rem] flex align-middle justify-center pt-2 flex-col'>
          <img src={images5} className='h-[10rem] w-[10rem] ms-[2.2rem] my-3'/>
            <h1 className='text-center text-white text-2xl font-bold'>Electrical <br/>mobility</h1>
         </div>
         <div className='card bg-green-600 w-[14.5rem] h-[19rem] flex align-middle justify-center pt-2 flex-col'>
          <img src={images6} className='h-[10rem] w-[10rem] ms-[2.2rem] my-3'/>
            <h1 className='text-center text-white text-2xl font-bold'>Solar charging <br/>station</h1>
         </div>
         <div className='card bg-green-500 w-[14.5rem] h-[19rem] flex align-middle justify-center pt-2 flex-col'>
          <img src={images7} className='h-[10rem] w-[10rem] ms-[2.2rem] my-3'/>
            <h1 className='text-center text-white text-2xl font-bold'>Recycling<br/>Plastic</h1>
         </div>
         <div className='card bg-green-600 w-[14.5rem] h-[19rem] flex align-middle justify-center pt-2 flex-col'>
          <img src={images8} className='h-[10rem] w-[10rem] ms-[2.2rem] my-3'/>
            <h1 className='text-center text-white text-2xl font-bold'>Cleaning<br/>Ocean</h1>
         </div>
         </div>
