  ...
  return (
    <div className="Probelms w-[26rem] mt-[8rem]">
      ...
      <div className="flex flex-row w-[67rem]">
        <p className="mt-[4rem] ms-[9rem] text-[1.70rem] font-medium text-gray-700  ">
          ...
          conservation movement lobbies for protection of endangered species and
          protection of any ecologically valuable natural areas, genetically
